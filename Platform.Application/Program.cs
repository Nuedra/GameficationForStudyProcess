...
try
{
    ...
    {
        var compactFormatter = new RenderedCompactJsonFormatter();
        loggerConfiguration
            .ReadFrom.Configuration(context.Configuration)
            .ReadFrom.Services(services)
            .Enrich.FromLogContext()
            .WriteTo.Logger(securityLogger => securityLogger
                .Filter.ByIncludingOnly(PlatformLogFilters.IsSecurityEvent)
                .WriteTo.File(
                    compactFormatter,
                    "logs/security-.clef",
                    ...
                    shared: true))
            .WriteTo.Logger(businessLogger => businessLogger
                .Filter.ByIncludingOnly(PlatformLogFilters.IsBusinessEvent)
                .WriteTo.File(
                    compactFormatter,
                    "logs/business-.clef",
                    rollingInterval: RollingInterval.Day,
    ...
    builder.Services.AddScoped<IStaffCourseExportService, StaffCourseExportService>();
    ...
    app.UseSerilogRequestLogging(options =>
    {
        ...
        options.EnrichDiagnosticContext = SerilogRequestLogEnricher.EnrichFromRequest;
    });
    app.UseAuthentication();
    app.UseMiddleware<AuthenticatedUserLogContextMiddleware>();
